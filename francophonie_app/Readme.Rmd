...
Les calculs statistiques, les graphiques et l'application ont été réalisés dans l'environnement de développement intégré RStudio- [Posit]("https://posit.co/"). L'application est écrite en langage R et son code peut être consulté à l'adresse suivante: github ***
...
Pour toute question:
: [Pascal Brissette]("pascal.brissette@mcgill.ca")
